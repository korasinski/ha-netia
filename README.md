...
`NOTE: Ensure your device software is up-to-date. This integration requres at least 8.X software version. Tested on: 8.4.03-103`
...
> <sup>All trademarks and registered trademarks presented in the pictures above are property of their respective owners.</sup><br> > <sup><sup>Custom component based on <a href="https://github.com/custom-components/media_player.braviatv_psk">braviatv_psk</a><sup></sup>
